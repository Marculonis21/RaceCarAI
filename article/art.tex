    ...
    \section{Projekt - AI-Závodník}
        ...
        \subsection{Závodníci}
            ...
            \begin{figure}[H]
                ...
                \captionof{figure}{Model vozidla}
                \label{fig:carpic}
            \end{figure}
            ...
            \begin{minipage}[t]{.5\textwidth}
                \centering
                % \includegraphics[width=0.9\linewidth]{data/perceptron-model1.png}
                \animatedgraphcs[autoplay,width=1\linewidth]{24}{data/forward/r_}{1}{54}
            \end{minipage}%
            \begin{minipage}[t]{.5\textwidth}
                \centering
                % \includegraphics[width=0.85\linewidth]{data/easynn-scheme.png}
                \animatedgraphcs[autoplay,width=1\linewidth]{24}{data/spin/r_}{1}{90}
            \end{minipage}
        ...
        \subsection{Trénink závodníků}
            ...
            \begin{minipage}[t]{.5\textwidth}
                \centering
                \includegraphics[width=1\linewidth]{../saves/f0.png}
            \end{minipage}%
            \begin{minipage}[t]{.5\textwidth}
                \centering
